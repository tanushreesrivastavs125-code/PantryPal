...
const MealPlanSkeleton = ({ view = 'grid', count = 6 }) => {
  if (view === 'details') {
    return (
      <div className="space-y-6 max-w-4xl mx-auto">
        <div className="h-8 w-48 bg-[rgba(138,144,112,0.1)] rounded-xl animate-pulse" />
        <div className="h-44 bg-white rounded-2xl border border-[rgba(138,144,112,0.15)] p-6 space-y-4 animate-pulse">
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Grid, Table, or Calendar Skeleton */}
      {view === 'table' ? (
